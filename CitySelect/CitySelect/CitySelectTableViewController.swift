...
class CitySelectTableViewController: BaseTableViewController, SearchViewDelegate {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if isSearch == true {
            ...
            datas = dataSource[indexPath.section].objectForKey("datas") as! NSMutableArray
            data = datas[indexPath.row] as! NSDictionary
        }
        ...
        if selectType == citySelectType.city {
            ...
            navigationController?.popToViewController(delegate as! UIViewController, animated: false)
        }
    }
